...
/*
 * implementing with PropertyChangeListener which has a single abstract method 
 * propertyChange() which called whenever PropertyChangeSupport.firePropertyChange() 
 * is invoked
 */
